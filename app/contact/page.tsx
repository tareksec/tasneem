          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
            <SlideIn direction="left" distance={20} duration={0.45} className="flex flex-col gap-6">
              ...
              <div className="border border-[#E5E7EB] rounded-3xl bg-white p-6 sm:p-7 shadow-xs flex flex-col gap-4 text-xs sm:text-sm">
                ...
                {/* Official LinkedIn */}
                <div className="flex items-start gap-3 pt-3 border-t border-slate-100">
                  <div className="w-8 h-8 rounded-xl bg-[#0A66C2]/10 text-[#0A66C2] flex items-center justify-center shrink-0 mt-0.5">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  ...
                  <div className="min-w-0">
                    <span className="text-xs font-bold text-slate-500 block">
                      {isBn ? "অফিসিয়াল লিঙ্কডইন পেজ" : "Official LinkedIn"}
                    </span>
                    <a
                      href={COMPANY_INFO.linkedin || "https://www.linkedin.com/company/tasneem-knitting-industry/"}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs sm:text-sm font-bold text-[#0A66C2] hover:underline transition-colors block break-all mt-0.5"
                    >
                      linkedin.com/company/tasneem-knitting-industry
                    </a>
                  </div>
                </div>
