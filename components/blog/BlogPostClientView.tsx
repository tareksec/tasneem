...
export function BlogPostClientView({ post, slug }: BlogPostClientViewProps) {
  ...
  const body =
    readingLocale === "en"
      ? post.body_en || post.body_bn
      : post.body_bn || post.body_en;
...
export default BlogPostClientView;
