...
// Attempt to register MorphSVGPlugin if available in runtime environment
if (typeof window !== "undefined") {
    try {
        ...
        import("gsap/MorphSVGPlugin").then((plugin) => {
            ...
            // MorphSVGPlugin is a Club GreenSock plugin. Gracefully falls back to standard keyframe transforms.
        });
    } catch {
...
// Helper component for Morphing Animated Icons
const MorphingIcon = ({
    type,
    isActive,
    onClick,
    ...
    const baseSvgClass = "w-[22px] h-[22px] fill-none stroke-current stroke-2 [stroke-linecap:round] [stroke-linejoin:round] pointer-events-none";
    ...
    if (type === 'home') {
        return (
            <button
                ...
                className={cn("home relative flex items-center justify-center w-full h-full cursor-pointer bg-transparent border-none p-0 outline-none", isActive ? "active" : "")}
                aria-label="Home"
            >
                <svg viewBox="0 0 24 24" className={baseSvgClass}>
    ...
    if (type === 'blog') {
        return (
            <button
                ...
                onClick={onClick}
                onMouseEnter={handleMouseEnter}
                className={cn("blog relative flex items-center justify-center w-full h-full cursor-pointer bg-transparent border-none p-0 outline-none", isActive ? "active" : "")}
                aria-label="Blog"
            >
                <svg viewBox="0 0 24 24" className={baseSvgClass}>
    ...
    if (type === 'marker') {
        return (
            <button
                ...
                onClick={onClick}
                onMouseEnter={handleMouseEnter}
                className={cn("marker relative flex items-center justify-center w-full h-full cursor-pointer bg-transparent border-none p-0 outline-none", isActive ? "active" : "")}
                aria-label="Location"
            >
                <svg viewBox="0 0 24 24" className={baseSvgClass}>
    ...
    if (type === 'email') {
        return (
            <button
                ...
                onClick={onClick}
                onMouseEnter={handleMouseEnter}
                className={cn("email relative flex items-center justify-center w-full h-full cursor-pointer bg-transparent border-none p-0 outline-none", isActive ? "active" : "")}
                aria-label="Email"
            >
                <svg viewBox="0 0 24 24" className={baseSvgClass}>
    ...
    if (type === 'linkedin') {
        return (
            <button
                ...
                onClick={onClick}
                onMouseEnter={handleMouseEnter}
                className={cn("linkedin relative flex items-center justify-center w-full h-full cursor-pointer bg-transparent border-none p-0 outline-none", isActive ? "active" : "")}
                aria-label="LinkedIn"
            >
                <svg viewBox="0 0 24 24" className={baseSvgClass}>
    ...
    if (type === 'x') {
        return (
            <button
                ...
                onClick={onClick}
                onMouseEnter={handleMouseEnter}
                className={cn("x relative flex items-center justify-center w-full h-full cursor-pointer bg-transparent border-none p-0 outline-none", isActive ? "active" : "")}
                aria-label="X"
            >
                <svg viewBox="0 0 24 24" className={baseSvgClass}>
    ...
    if (type === 'github') {
        return (
            <button
                ...
                onClick={onClick}
                onMouseEnter={handleMouseEnter}
                className={cn("github relative flex items-center justify-center w-full h-full cursor-pointer bg-transparent border-none p-0 outline-none", isActive ? "active" : "")}
                aria-label="GitHub"
            >
                <svg viewBox="0 0 24 24" className="w-[22px] h-[22px] pointer-events-none">
...
export const GlassDock = React.forwardRef<HTMLDivElement, GlassDockProps>(
    (
        ...
        // Calibrated tooltip center position: (item width 40 + gap 10) * index + offset
        const getTooltipPosition = (index: number) => index * 50 + 10;
        ...
        return (
            ...
            >
                <nav
                    ...
                    className={cn(
                        "glass-dock relative flex gap-2 sm:gap-2.5 items-center px-3 py-2 rounded-2xl",
                        "bg-[#2D2D2D]/92 border border-white/15",
                        "backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.45)] justify-center",
                        dockClassName
                    )}
                    onMouseLeave={() => {
                ...
                >
                            ...
                            >
                                <div
                                    className={cn(
                                        ...
                                        'bg-[#1E1E1E] text-white text-xs font-semibold tracking-wide',
                    ...
                    {items.map((el, index) => {
                        ...
                        const isActive = el.isActive ?? isHovered;
                        ...
                        // Check if title matches one of the built-in morphing icons
                        ...
                        return (
                            <div
                                ...
                                onClick={handleClick}
                                className={cn(
                                    "relative w-10 h-10 flex items-center justify-center cursor-pointer rounded-xl transition-all duration-200 select-none",
                                    isActive
                                        ? "bg-[#800020] text-white shadow-[0_2px_10px_rgba(128,0,32,0.45)] ring-1 ring-white/20"
