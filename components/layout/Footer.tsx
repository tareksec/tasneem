            ...
            <div className="lg:col-span-3 flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2.5 text-xs text-neutral-600">
                ...
                <a
                  ...
                  className="mt-1 bg-emerald-600 hover:bg-emerald-500 text-white px-3.5 py-2.5 rounded-xl flex items-center justify-between text-xs font-semibold transition-colors shadow-2xs w-full min-h-[44px]"
                >
            ...
            <div className="max-w-5xl mx-auto bg-white/95 backdrop-blur-md rounded-2xl sm:rounded-full px-3.5 sm:px-8 py-3.5 shadow-[0_12px_36px_rgba(0,0,0,0.1)] border border-neutral-200/90 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
                ...
                <a
                  ...
                  className="w-9 h-9 sm:w-8 sm:h-8 rounded-full bg-neutral-100 hover:bg-neutral-200 text-neutral-700 flex items-center justify-center transition-colors shadow-2xs shrink-0"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  className="w-9 h-9 sm:w-8 sm:h-8 rounded-full bg-emerald-50 hover:bg-emerald-100 text-emerald-600 flex items-center justify-center transition-colors shadow-2xs shrink-0"
                >
