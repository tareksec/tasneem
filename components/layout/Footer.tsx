            ...
            <div className="max-w-6xl mx-auto bg-white/95 backdrop-blur-md rounded-2xl sm:rounded-full px-4 sm:px-8 py-3.5 shadow-[0_12px_36px_rgba(0,0,0,0.1)] border border-neutral-200/90 flex flex-col lg:flex-row items-center justify-between gap-3 sm:gap-4">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-2.5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Tasneem LinkedIn Company Profile"
                  className="w-9 h-9 sm:w-8 sm:h-8 rounded-full bg-neutral-100 hover:bg-[#0A66C2] hover:text-white text-neutral-700 flex items-center justify-center transition-colors shadow-2xs shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#800020]"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
