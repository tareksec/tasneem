  ...
  return (
    <aside aria-label="WhatsApp Quick Contact">
      <a
        ...
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 bg-emerald-600 hover:bg-emerald-500 text-white p-3 sm:p-4 rounded-full shadow-2xl hidden md:flex items-center justify-center gap-2.5 transition-all duration-300 hover:scale-105 border-2 border-[#161616] ring-1 ring-[#2A2A2A] group min-w-[48px] min-h-[48px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
      >
