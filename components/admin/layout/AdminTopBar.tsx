...
export function AdminTopBar({ onToggleMobileSidebar }: AdminTopBarProps) {
  ...
  return (
    <header className="px-6 sm:px-8 lg:px-10 pt-6 sm:pt-8 pb-4 flex flex-col md:flex-row md:items-center justify-between gap-4 select-none">
      ...
      <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-full bg-white/90 hover:bg-white border border-slate-200/80 text-xs font-semibold text-slate-800 shadow-2xs transition-colors cursor-pointer"
          >
            {/* Facebook/Globe icon */}
            <div className="w-4 h-4 rounded-full bg-[#1877F2] text-white flex items-center justify-center text-[10px] font-bold">
              f
            </div>
            <span className="max-w-[150px] sm:max-w-[190px] truncate">facebook.com/tasneemknit</span>
            <ChevronDown className="w-3.5 h-3.5 text-slate-400" />
          </button>

          {showDomainMenu && (
            <div className="absolute left-0 mt-2 w-64 rounded-2xl bg-white p-2 shadow-xl border border-slate-200/80 z-50 animate-in fade-in zoom-in-95">
              <div className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400">
                Connected Properties
              </div>
              <a
                href="https://facebook.com/tasneemknit"
                target="_blank"
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span>facebook.com/tasneemknit</span>
                </div>
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            placeholder="Search..."
            className="w-36 sm:w-48 md:w-56 pl-9 pr-4 py-2 text-xs rounded-full bg-white/90 hover:bg-white focus:bg-white border border-slate-200/80 text-slate-800 placeholder-slate-400 shadow-2xs focus:outline-none focus:ring-2 focus:ring-slate-900/10 transition-all"
          />
        </div>
        ...
        <div className="hidden sm:flex items-center bg-white/90 border border-slate-200/80 rounded-full p-0.5 shadow-2xs">
          <button
            ...
            className={cn(
              ...
              contentLocale === "en"
                ? "bg-[#111217] text-white shadow-2xs"
          ...
          <button
            ...
            className={cn(
              "px-2.5 py-1 rounded-full text-[11px] font-bold transition-all duration-150 cursor-pointer",
              contentLocale === "bn"
                ? "bg-[#FF5579] text-white shadow-2xs"
                : "text-slate-500 hover:text-slate-900"
            )}
          >
            বাংলা
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-[#111217] hover:bg-slate-850 text-white text-xs font-bold shadow-sm transition-all duration-200 active:scale-[0.98] cursor-pointer"
        >
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-[#FF4565] text-white text-[9px] font-extrabold flex items-center justify-center ring-2 ring-white">
              6
            </span>
          </button>

          {showNotifications && (
            <div className="absolute right-0 mt-2 w-80 rounded-3xl bg-white p-4 shadow-2xl border border-slate-200/80 z-50 animate-in fade-in zoom-in-95">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                <span className="text-xs font-bold text-slate-900 uppercase tracking-wider">
                  Live Notifications
                </span>
                <span className="text-[10px] font-bold text-[#FF5579] bg-rose-50 px-2.5 py-0.5 rounded-full">
                  6 New
                </span>
              </div>
